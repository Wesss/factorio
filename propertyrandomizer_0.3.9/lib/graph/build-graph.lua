...
-- TODO WESD lkp - randomizer graph construction
...
-- TODO WESD lkp - randomizer getting all materials (items and fluids)
local materials = {}
...
local function load()
    ...
    for _, fluid in pairs(data.raw.fluid) do
        ...
        -- TODO WESD lkp - randomizer add fluids to graph
    ...
    -- TODO WESD lkp - randomizer add items to graph
    ...
    for item_class, _ in pairs(defines.prototypes.item) do
        if data.raw[item_class] ~= nil then
            for _, item in pairs(data.raw[item_class]) do
                ...
                -- TODO WESD lkp - randomizer checking if tiles can result in item
                for _, tile in pairs(data.raw.tile) do
    ...
    -- TODO WESD lkp - randomizer add recipes to graph
    for _, recipe in pairs(data.raw.recipe) do
        prereqs = {}
