...
data:extend({{
    ...
    collision_box = {{-1.3999999999999999, -1.3999999999999999}, {1.3999999999999999, 1.3999999999999999}},
    ...
    flags = {"player-creation", "placeable-player", "not-flammable", "hidden"},
    tint = {
        r = 0.4,
        g = 0.4,
        b = 1.0
    ...
    autoplace = {
        ...
        probability_expression = noise.define_noise_function(function(x, y, tile, map)
            ...
            local k = 1 / 30000
            local k2 = 1 / 80000
            return starting + basis_noise(10, k) +
                       noise.max(0, ((basis_noise(50, 2) ^ 5) * k2) * basis_noise(300, 1) * basis_noise(1500, 1.25))
        end)
    }
}})
